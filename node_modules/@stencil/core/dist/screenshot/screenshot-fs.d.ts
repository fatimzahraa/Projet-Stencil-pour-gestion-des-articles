...
export declare function writeScreenshotData(dataDir: string, screenshotData: d.ScreenshotData): Promise<void>;
export declare function readScreenshotData(dataDir: string, screenshotId: string): Promise<d.ScreenshotData>;
