...
class NodeLazyRequire {
    constructor(nodeResolveModule, semver, stencilPackageJson) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const depsToInstall = [];
            const promises = ensureModuleIds.map((ensureModuleId) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const installedPkgJson = yield readPackageJson(resolvedPkgJsonPath);
            ...
            try {
                ...
                yield npmInstall(logger, fromDir, installModules);
